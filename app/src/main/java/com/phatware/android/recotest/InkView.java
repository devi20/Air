...
import com.phatware.android.utils.ShortcutActions;
...
public class InkView extends View implements RecoTest.OnInkViewListener {
    ...
    private final Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            shortcutActions = new ShortcutActions(getContext());
            ...
            for (int w = 0; w < words; w++) {
                ...
                if (alternatives > 0) {
                    ...
                    for (int a = 0; a < alternatives; a++) {
                        ...
                        if(dbHelper.getAction(word)==null)
                        {

                        }
                        else
                        {
                            shortcutActions.select(dbHelper.getAction(word).getAction());
                        }
